...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "application-card" }, _attrs))} data-v-b507b2ce><div class="application-card__header" data-v-b507b2ce><div class="application-card__header-left" data-v-b507b2ce><span class="${ssrRenderClass([_ctx.resource.type, "application-card__type"])}" data-v-b507b2ce>${ssrInterpolate(_ctx.resource.type)}</span><span class="${ssrRenderClass([_ctx.resource.isRecommended ? "approved" : "pending", "application-card__status"])}" data-v-b507b2ce>${ssrInterpolate(_ctx.resource.isRecommended ? "Рекомендован" : "Не рекомендован")}</span></div></div><div class="application-card__avatar-container" data-v-b507b2ce><img${ssrRenderAttr("src", `http://localhost:3001${_ctx.resource.avatarUrl}`)} alt="Application Avatar" class="application-card__avatar" data-v-b507b2ce><h3 class="application-card__title" data-v-b507b2ce>${ssrInterpolate(_ctx.resource.title)}</h3></div><p class="application-card__description" data-v-b507b2ce>${ssrInterpolate(_ctx.resource.description)}</p><div class="application-card__footer" data-v-b507b2ce><button class="application-card__button approve" data-v-b507b2ce>Сделать рекомендованным</button><button class="application-card__button reject" data-v-b507b2ce>Убрать из рекомендованных</button></div></div>`);
    };
  }
});
...
const RecommendedCard = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-b507b2ce"]]), { __name: "RecommendedCard" });
const _sfc_main = {
  __name: "recommend",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=recommend-D04wTFVo.mjs.map
