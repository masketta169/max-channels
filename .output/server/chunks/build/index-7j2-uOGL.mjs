...
import { r as resourceService } from './resources-PPYOMjio.mjs';
import { s as submissionService } from './submissions-B17u1zQ9.mjs';
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "search" }, _attrs))} data-v-04fc5dcd><input type="text" class="search__input" placeholder="Поиск чатов, каналов, ботов..."${ssrRenderAttr("value", unref(searchQuery))} data-v-04fc5dcd><button class="search__btn" data-v-04fc5dcd><svg class="search__icon" viewBox="0 0 24 24" data-v-04fc5dcd><path d="M15.5 14h-.79l-.28-.27a6.5 6.5 0 0 0 1.48-5.34c-.47-2.78-2.79-5-5.59-5.34a6.505 6.505 0 0 0-7.27 7.27c.34 2.8 2.56 5.12 5.34 5.59a6.5 6.5 0 0 0 5.34-1.48l.27.28v.79l4.25 4.25c.41.41 1.08.41 1.49 0 .41-.41.41-1.08 0-1.49L15.5 14zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" data-v-04fc5dcd></path></svg></button></div>`);
    };
  }
};
...
const SearchInput = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-04fc5dcd"]]);
const _sfc_main$5 = {
  __name: "AuthButtons",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "auth-buttons" }, _attrs))} data-v-28eb4314><button class="auth-buttons__btn auth-buttons__btn--login" data-v-28eb4314> Войти </button><button class="auth-buttons__btn auth-buttons__btn--register" data-v-28eb4314> Регистрация </button></div>`);
    };
  }
};
...
const AuthButtons = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-28eb4314"]]);
const _sfc_main$4 = {
  __name: "AppHeader",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "card" }, _attrs))} data-v-ff02ad94><div class="card__content" data-v-ff02ad94><img${ssrRenderAttr("src", `https://max-community.ru${__props.item.avatarUrl}`)} alt="Card Image" class="card__image" data-v-ff02ad94><div class="card__meta" data-v-ff02ad94><h4 class="card__title" data-v-ff02ad94>${ssrInterpolate(__props.item.title)}</h4><p class="card__description" data-v-ff02ad94>${ssrInterpolate(__props.item.description)}</p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: __props.item.url,
        class: "card__link",
        target: "_blank",
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ff02ad94"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-331c7a06>`);
      _push(ssrRenderComponent(_component_AppHeader, null, null, _parent));
      _push(`<main class="main" data-v-331c7a06>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-331c7a06"]]);

export { index as default };
//# sourceMappingURL=index-7j2-uOGL.mjs.map
