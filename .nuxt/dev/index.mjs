...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/andrejbelaev/Desktop/Проекты/Max-app/max-channels/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/andrejbelaev/Desktop/Проекты/Max-app/max-channels","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/andrejbelaev/Desktop/Проекты/Max-app/max-channels/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/andrejbelaev/Desktop/Проекты/Max-app/max-channels/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/andrejbelaev/Desktop/Проекты/Max-app/max-channels/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/andrejbelaev/Desktop/Проекты/Max-app/max-channels/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/andrejbelaev/Desktop/Проекты/Max-app/max-channels/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _MwX2pWe0jndBl9Aklh9vke41VHXj1PBXTTS03Da34 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/andrejbelaev/Desktop/Проекты/Max-app/max-channels";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"description","content":"Max Community"},{"name":"keywords","content":"telegram, чаты, каналы, боты, MAX community, рекомендованные"},{"name":"author","content":"Max Community"},{"name":"robots","content":"index, follow"},{"name":"googlebot","content":"index, follow"},{"name":"google","content":"notranslate"},{"name":"format-detection","content":"telephone=no"},{"name":"viewport","content":"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"}],"link":[],"style":[],"script":[{"innerHTML":"(function(m,e,t,r,i,k,a){\n            m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};\n            m[i].l=1*new Date();\n            for (var j=0;j<document.scripts.length;j++){if(document.scripts[j].src===r){return}}\n            k=e.createElement(t),a=e.getElementsByTagName(t)[0];\n            k.async=1;k.src=r;a.parentNode.insertBefore(k,a)\n          })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=104187556','ym');\n          ym(104187556,'init',{\n            ssr:true,\n            webvisor:true,\n            clickmap:true,\n            ecommerce:\"dataLayer\",\n            accurateTrackBounce:true,\n            trackLinks:true\n          });"},{"innerHTML":"window.yaContextCb=window.yaContextCb||[]"},{"src":"https://yandex.ru/ads/system/context.js","async":true}],"noscript":[{"innerHTML":"<div><img src=\"https://mc.yandex.ru/watch/104187556\" style=\"position:absolute; left:-9999px;\" alt=\"\" /></div>"}],"title":"Max Community"};
...
const _LqugT469hPPmrw0ARRDu7ELoxt9YFQu5hcvmyULGFNA = (nitroApp) => {
...
const plugins = [
  _MwX2pWe0jndBl9Aklh9vke41VHXj1PBXTTS03Da34,
_LqugT469hPPmrw0ARRDu7ELoxt9YFQu5hcvmyULGFNA
];
...
const _YJwkQk = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _7As0ex = eventHandler(async (event) => {
  ...
  return await import('file:///Users/andrejbelaev/Desktop/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B/Max-app/max-channels/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _nLL3SW = eventHandler(async (event) => {
...
const _lazy_jHZW5m = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _YJwkQk, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_jHZW5m, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _7As0ex, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _nLL3SW, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_jHZW5m, lazy: true, middleware: false, method: undefined }
];
